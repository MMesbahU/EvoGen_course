...
PLEASE BE AWARE THAT THIS MATERIAL IS NOT UP-TO-DATE AND MAY NOT WORK WITH MORE RECENT VERSIONS OF ANGSD/NGSTOOLS.

WE RECOMMEND CHECKING WORKSHOPS LABELLED AS `COPENHAGEN` OR `ANKARA` INSTEAD.
